# Generated by Django 2.2 on 2021-04-21 14:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_caption', models.CharField(default='Phot by Blog', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('likes_comment', models.ManyToManyField(blank=True, default=None, related_name='comment_like', to=settings.AUTH_USER_MODEL)),
